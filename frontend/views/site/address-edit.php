    ...
    <div class="content fl ml10">
        <!--<div class="address_hd">
            ...
            <dl id="<?/*=$row->id*/?>">
                ...
                <dd>
                    <a href="<?/*=\yii\helpers\Url::to(['site/update','id'=>$row->id])*/?>" id="adupdate">修改</a>
                    <a href="" id="addelete">删除</a>
                    <a href="" id ="adedit">设为默认地址</a>
                </dd>
            </dl>
            <?php /*endforeach;*/?>
        </div>-->
        <div class="address_bd mt10">
            <h4>修改收货地址</h4>
            <form  id='form' action="<?=\yii\helpers\Url::to(['site/address-update','id'=>$address->id])?>" name="address_form" method="post">
                <ul>
                    <li>
                    ...
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="status" class="check" value="1" <?=$address->status==1?'checked':''?>/>设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
...
//        var id = $('#adid').val();
//        $.post("<?//=\yii\helpers\Url::to(['site/address-update'])?>//",info,function (data) {
