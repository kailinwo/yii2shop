...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <li>您好，欢迎来到京西！[<a href="<?=\yii\helpers\Url::to(['site/user-login'])?>">登录</a>] [<a href="<?=\yii\helpers\Url::to(['site/register'])?>">免费注册</a>] </li>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
                <li>客户服务</li>
            ...
            <form action="<?=\yii\helpers\Url::to(['site/register'])?>" method="post" id="signupForm">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="password" class="txt" name="re_password_hash" />
                        <p> <span>请再次输入密码</p>
                    </li>
                    <li>
                        <label for="">邮箱：</label>
...
<script type="text/javascript">
    function bindPhoneNum(){
        ...
        //获取表单上面填写的电话号码发送给后端的发送短信的方法
        var phone = $("#tel").val();//得到
//        console.log(phone);
        ...
        $("#signupForm").validate({
            rules: {
                username: {
                    ...
                    minlength: 3,
                    remote: {//后台处理程序
                        url: "<?=\yii\helpers\Url::to(['site/check-user'])?>"
                    }
                },
                password_hash: {
                    required: true,
                ...
                captcha: {
                    ...
                    minlength: 4,
                    remote: {//后台处理程序
                        url: "<?=\yii\helpers\Url::to(['site/checksms'])?>",
                        data: {//要传递的数据
                            tel: function() {
                                return $("#tel").val();
                            }
