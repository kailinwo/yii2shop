    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=$goodsimage->path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="<?=$goodsimage->path?>" alt="" width="340px"/>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <?php foreach($goodsGallery as $k=>$goodsgallery):?>
                                <li <?=$k?'':'class="cur"'?>>
                                    <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$goodsgallery->path?>',largeimage: '<?=$goodsgallery->path?>'}"><img src="<?=$goodsgallery->path?>"></a>
                                </li>
                            <?php endforeach;?>
                        </ul>
                    </div>
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    ...
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=$goodsinfo->view_times?>人点击)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['site/cart-add'])?>" method="get" class="choose">
                    <ul>
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    ...
                    <div class="desc mt10">
                        ...
                        <?php
                        //如果商品的详情有东西就输出,没有输出空!
                        if($goodsdetails->content){
                            echo $goodsdetails->content;
                        }else{
                            echo '';
                        }
                        ?>
