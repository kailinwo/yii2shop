    ...
    <div class="list_bd fl ml10 mt10">
        ...
        <div class="goodslist mt10">
            <ul>
                ...
                <li>
                    <dl>
                        <dt><a href="<?=\yii\helpers\Url::to(['goods/details','id'=>$row->id])?>"><img src="<?=$row->logo?>" alt="logo" /></a></dt>
                        <dd><a href="<?=\yii\helpers\Url::to(['goods/details','id'=>$row->id])?>"><?=$row->name?></a></dt>
                        <dd><strong><?=$row->shop_price?></strong></dt>
                        <dd><a href=""><em>已有<?=$row->view_times?>人点击</em></a></dt>
                    </dl>
                </li>
                <?php endforeach;?>
            </ul>
